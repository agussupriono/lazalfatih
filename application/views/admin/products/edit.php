...
<div class="col-md-6">
	<div class="form-group input-group-lg">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control">
              ...
              <option value="publish" <?php if($product['status']=="publish") { echo "selected"; } ?>>Publish</option>}
    ...
    <div class="form-group">
        ...
        <textarea name="product_description" placeholder="Product Description" class="form-control"><?php echo $product['product_description'] ?></textarea>
    </div>                              
</div>
<div class="col-md-12">
<div class="form-group">
